...
export default function CalendarScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}><Text style={styles.title}>イベント予定</Text><TouchableOpacity style={styles.addButton} onPress={() => router.push('/create')}><Ionicons name="add" size={25} color={palette.surface} /></TouchableOpacity></View>
