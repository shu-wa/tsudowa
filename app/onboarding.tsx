...
export default function OnboardingScreen() {
  ...
  const finish = async () => {
    ...
    setSubmitting(true);
    const error = await completeOnboarding({ name, email, dateOfBirth });
    setSubmitting(false);
